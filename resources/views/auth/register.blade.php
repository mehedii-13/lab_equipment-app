        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-5 relative z-10">
            ...
            <div>
                <div class="rounded-2xl border border-slate-800 bg-slate-950/70 p-4 text-sm text-slate-300">
                    Students can register only with a <span class="font-semibold text-teal-400">@stud.kuet.ac.bd</span> email address.
                    Admin and super admin accounts are created by the super admin from the dashboard.
                </div>
            </div>
