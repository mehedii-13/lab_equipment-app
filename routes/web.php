...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:super_admin')->group(function () {
        ...
        Route::patch('/super-admin/departments/{department}', [SuperAdminController::class, 'updateDepartment'])->name('super_admin.departments.update');
        Route::post('/super-admin/labs', [SuperAdminController::class, 'storeLab'])->name('super_admin.labs.store');
        Route::patch('/super-admin/labs/{lab}', [SuperAdminController::class, 'updateLab'])->name('super_admin.labs.update');
